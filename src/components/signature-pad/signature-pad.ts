...
export class SignaturePadComponent {
  ...
  public initSignaturePad(options: IOptions) {
    ...
    if (this.throttle) {
      this._strokeMoveUpdate = throttle(
        SignaturePadComponent.prototype._strokeUpdate,
        this.throttle,
      );
    } else {
      this._strokeMoveUpdate = SignaturePadComponent.prototype._strokeUpdate;
    }

    this.dotSize =
      options.dotSize ||
      function dotSize(this: SignaturePadComponent) {
  ...
  private _fromData(
    ...
    drawCurve: SignaturePadComponent['_drawCurve'],
    drawDot: SignaturePadComponent['_drawDot'],
  ): void {
